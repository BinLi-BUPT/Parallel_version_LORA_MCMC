...
def LORA(fun, xMin, xMax, samples_num, N, RN, D, num_node, num_cpu):
    ...
    Rot1, xMin1, xMax1, cluster_centre, cluster_centre_rot, time_part_1 = Mutlimodal_density_separation(fun, xMin, xMax,
                                                                                                        N, RN, 1e-10,
                                                                                                        1e-10, num_node,
                                                                                                        num_cpu)
    ...
    C_pr1, R1, c_ind1, time_part_3_1 = Reconstruct_lowrank_proposal(fun, Rot2_1, xMin2_1, xMax2_1, N, RN, num_node,
                                                                    num_cpu)
    C_pr2, R2, c_ind2, time_part_3_2 = Reconstruct_lowrank_proposal(fun, Rot2_2, xMin2_2, xMax2_2, N, RN, num_node,
                                                                    num_cpu)
    C_pr3, R3, c_ind3, time_part_3_3 = Reconstruct_lowrank_proposal(fun, Rot2_3, xMin2_3, xMax2_3, N, RN, num_node,
                                                                    num_cpu)
    ...
    best_w, max_mean_alpha, W1, W2, mean_alphas, samples, mean_alpha, samples_alphas, samples_p, time_part_5 = Global_alignment(
        samples_all, samples_p_all, 1000, 80000, [[0.1, 0.9], [0.1, 0.9]], num_node, num_cpu)
        ...
        for num_node in num_node_list:
            for num_cpu in num_cpu_list:
                ...
                for run in range(run_time):
                    ...
                    samples, samples_p, samples_alphas, peaks_inf, time_list, res = LORA(fun, xMin, xMax, samples_num, N, RN, D, num_node, num_cpu)
